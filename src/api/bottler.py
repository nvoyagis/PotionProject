    ...
    with db.engine.begin() as connection:
        for potion in potions_delivered:
            ...
            if potion.potion_type == [100, 0, 0, 0]:
                ...
                connection.execute(sqlalchemy.text("UPDATE global_inventory SET num_red_ml = " + (cur_red_ml - red_ml)))
                ...
                connection.execute(sqlalchemy.text("UPDATE global_inventory SET num_green_ml = " + (cur_green_ml - green_ml)))
                ...
                connection.execute(sqlalchemy.text("UPDATE global_inventory SET num_blue_ml = " + (cur_blue_ml - blue_ml)))
            ...
            connection.execute(sqlalchemy.text("UPDATE global_inventory SET num_red_potions = " + cur_red_quantity))
            ...
            connection.execute(sqlalchemy.text("UPDATE global_inventory SET num_green_potions = " + cur_green_quantity))
            ...
            connection.execute(sqlalchemy.text("UPDATE global_inventory SET num_blue_potions = " + cur_blue_quantity))
